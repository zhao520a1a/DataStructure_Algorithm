...
public class MyHashMap_linked<K, V> {
    ...
    // 自己设置容量和装载因子的构造器
    public MyHashMap_linked(int init_Capaticy, float load_factor) {
    ...
    public static void main(String[] args) {
        MyHashMap_linked<String, String> mm = new MyHashMap_linked<String, String>();
